...
time4=Tk()
time4.geometry('1408x792+50+0')
time4.resizable(0,0)
time4.title("time4 Slots")

header_frame = Frame(time4, bg="white", height=80)
...
step3 = Label(time4, text="Select time4 Slot",bg='#19423c',fg='white',
              font=('Microsoft Yahei UI Light',15,'bold'))
step3.place(x=600,y=700)


a0_1 = Label(time4, text="7am",font=('Microsoft Yahei UI Light',13,'bold'),fg='#19423c', bg="white",width=7,height=1)
a0_1.place(x=215, y=145)

a0_2 = Label(time4, text="8am",font=('Microsoft Yahei UI Light',13,'bold'),fg='#19423c', bg="white",width=7)
a0_2.place(x=215, y=177)

a0_3 = Label(time4, text="9am",font=('Microsoft Yahei UI Light',13,'bold'),fg='#19423c', bg="white",width=7)
a0_3.place(x=215, y=209)

a0_4 = Label(time4, text="10am",font=('Microsoft Yahei UI Light',13,'bold'),fg='#19423c', bg="white",width=7)
a0_4.place(x=215, y=241)

a0_5 = Label(time4, text="11am",font=('Microsoft Yahei UI Light',13,'bold'),fg='#19423c', bg="white",width=7)
a0_5.place(x=215, y=273)

a0_6 = Label(time4, text="12pm",font=('Microsoft Yahei UI Light',13,'bold'),fg='#19423c', bg="white",width=7)
a0_6.place(x=215, y=305)

a0_7 = Label(time4, text="1pm",font=('Microsoft Yahei UI Light',13,'bold'),fg='#19423c', bg="white",width=7)
a0_7.place(x=215, y=337)

a0_8 = Label(time4, text="2pm",font=('Microsoft Yahei UI Light',13,'bold'),fg='#19423c', bg="white",width=7)
a0_8.place(x=215, y=369)

a0_9 = Label(time4, text="3pm",font=('Microsoft Yahei UI Light',13,'bold'),fg='#19423c', bg="white",width=7)
a0_9.place(x=215, y=401)

a0_10 = Label(time4, text="4pm",font=('Microsoft Yahei UI Light',13,'bold'),fg='#19423c', bg="white",width=7)
a0_10.place(x=215, y=433)

a0_11 = Label(time4, text="5pm",font=('Microsoft Yahei UI Light',13,'bold'),fg='#19423c', bg="white",width=7)
a0_11.place(x=215, y=465)

a0_12 = Label(time4, text="6pm",font=('Microsoft Yahei UI Light',13,'bold'),fg='#19423c', bg="white",width=7)
a0_12.place(x=215, y=497)

a0_13 = Label(time4, text="7pm",font=('Microsoft Yahei UI Light',13,'bold'),fg='#19423c', bg="white",width=7)
a0_13.place(x=215, y=529)

a0_14 = Label(time4, text="8pm",font=('Microsoft Yahei UI Light',13,'bold'),fg='#19423c', bg="white",width=7)
a0_14.place(x=215, y=561)

a0_15 = Label(time4, text="9pm",font=('Microsoft Yahei UI Light',13,'bold'),fg='#19423c', bg="white",width=7)
a0_15.place(x=215, y=593)

a0_16 = Label(time4, text="10pm",font=('Microsoft Yahei UI Light',13,'bold'),fg='#19423c', bg="white",width=7)
a0_16.place(x=215, y=625)

a0_17 = Label(time4, text="11pm",font=('Microsoft Yahei UI Light',13,'bold'),fg='#19423c', bg="white",width=7)
a0_17.place(x=215, y=657)

a1_0 = Label(time4, text="Sun",font=('Microsoft Yahei UI Light',13,'bold'),fg='#19423c', bg="white",width=10)
a1_0.place(x=300, y=113)

a2_0 = Label(time4, text="Mon",font=('Microsoft Yahei UI Light',13,'bold'),fg='#19423c', bg="white",width=10)
a2_0.place(x=420, y=113)

a3_0 = Label(time4, text="Tue",font=('Microsoft Yahei UI Light',13,'bold'),fg='#19423c', bg="white",width=10)
a3_0.place(x=540, y=113)

a4_0 = Label(time4, text="Wed",font=('Microsoft Yahei UI Light',13,'bold'),fg='#19423c', bg="white",width=10)
a4_0.place(x=660, y=113)

a5_0 = Label(time4, text="Thu",font=('Microsoft Yahei UI Light',13,'bold'),fg='#19423c', bg="white",width=10)
a5_0.place(x=780, y=113)

a6_0 = Label(time4, text="Fri",font=('Microsoft Yahei UI Light',13,'bold'),fg='#19423c', bg="white",width=10)
a6_0.place(x=900, y=113)

a7_0 = Label(time4, text="Sat",font=('Microsoft Yahei UI Light',13,'bold'),fg='#19423c', bg="white",width=10)
a7_0.place(x=1020, y=113)

#Sunday
a1_1 = Button(time4,text="-",font=('Microsoft Yahei UI Light',10,'bold'),fg='#19423c', bg="white",width=12,bd=0)
a1_1.place(x=302, y=145)

a1_2 = Button(time4,text="-",font=('Microsoft Yahei UI Light',10,'bold'),fg='#19423c', bg="white",width=12,bd=0)
a1_2.place(x=422, y=145)

a1_3 = Button(time4,text="-",font=('Microsoft Yahei UI Light',10,'bold'),fg='#19423c', bg="white",width=12,bd=0)
a1_3.place(x=542, y=145)

a1_4 = Button(time4,text="-",font=('Microsoft Yahei UI Light',10,'bold'),fg='#19423c', bg="white",width=12,bd=0)
a1_4.place(x=662, y=145)

a1_5 = Button(time4,text="-",font=('Microsoft Yahei UI Light',10,'bold'),fg='#19423c', bg="white",width=12,bd=0)
a1_5.place(x=782, y=145)

a1_6 = Button(time4,text="-",font=('Microsoft Yahei UI Light',10,'bold'),fg='#19423c', bg="white",width=12,bd=0)
a1_6.place(x=902, y=145)

a1_7 = Button(time4,text="-",font=('Microsoft Yahei UI Light',10,'bold'),fg='#19423c', bg="white",width=12,bd=0)
